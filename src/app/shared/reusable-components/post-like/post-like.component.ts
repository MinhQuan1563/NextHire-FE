...
export class PostLikeComponent implements OnInit {
  ...
  fetchLikes() {
    ...
    // setTimeout(() => {
    //   this.likes = [
    //     { userId: '1', userCode: 'nguyenvana', userName: 'Nguyễn Văn A', title: 'Software Engineer' },
    //     { userId: '2', userCode: 'tranthib', userName: 'Trần Thị B', title: 'HR Manager' },
    //     { userId: '3', userCode: 'lehoangc', userName: 'Lê Hoàng C', title: 'Frontend Developer' },
    //   ];
